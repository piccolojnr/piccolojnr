...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-[calc(100vh-3.5rem)] flex flex-col justify-center section-padding border-b border-border/60"
    >
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-12">
              ...
              <Button variant="ghost" className="rounded-md px-4" asChild>
          ...
          <div className="lg:col-span-5">
            <div className="aspect-[4/5] max-w-md mx-auto lg:max-w-none rounded-2xl border border-border bg-muted/40 overflow-hidden">
              <img
                src="/profile.jpg"
                alt="Rahim Daud"
        ...
        <a
          href="#about"
          className="hidden md:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center text-muted-foreground hover:text-foreground text-xs tracking-wide transition-colors"
        >
